...
INSERT INTO silver.dim_location (location_id, borough, zone, service_zone) VALUES
...
-- Codigos segun el diccionario de datos oficial de TLC (payment_type)
INSERT INTO silver.dim_payment_type (payment_type_id, payment_type_name) VALUES
(0, 'Flex Fare trip'),
(1, 'Credit card'),
(2, 'Cash'),
(3, 'No charge'),
...
INSERT INTO silver.dim_rate_code (rate_code_id, rate_code_name) VALUES
(1, 'Standard rate'),
(2, 'JFK'),
(3, 'Newark'),
...
-- Codigos segun el diccionario de datos oficial de TLC (VendorID)
INSERT INTO silver.dim_vendor (vendor_id, vendor_name) VALUES
(1, 'Creative Mobile Technologies, LLC'),
(2, 'Curb Mobility, LLC'),
(6, 'Myle Technologies Inc'),
(7, 'Helix'),
(-1, 'Desconocido / No Registrado')
